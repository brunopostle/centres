...
`todo` · `doing` · `done` · `dropped` — update in place, commit the change.
...
### A1 · Deduplicate blob detections per feature
**Status:** todo · **Blocks:** A2, A6, C1
...
### A2 · Make the scale ladder relative to image size and remove the ceiling
**Status:** todo · **Blocked by:** A1 · **Blocks:** C1
...
### A3 · Replace fixed Canny thresholds with locally adaptive edge detection
**Status:** todo · **Blocks:** C1
...
### A4 · Make the distance cap scale-relative
**Status:** todo · **Blocks:** C1
...
### A5 · Give strength propagation a fixed point
**Status:** todo · **Blocks:** C1
...
### A6 · Make the pipeline exactly invariant under isometries
**Status:** todo · **Blocked by:** A1 · **Blocks:** C1
...
### B1 · Make the energy terms consistently intensive
**Status:** todo
...
### B2 · Return "undefined" for the degenerate case, not 10/10
**Status:** todo
...
### B3 · Clamp the normalisers and re-derive the reference constants
**Status:** todo
...
### B4 · Wire the audit thresholds into the test suite
**Status:** todo · **Blocked by:** B1, B2, B3
...
### C1 · Re-run the sweeps and the invariance suite
**Status:** todo · **Blocked by:** A1–A6
...
### C2 · Extend the generators to all fifteen properties
**Status:** todo · **Blocked by:** C1
...
### C3 · Build the sensitivity matrix
**Status:** todo · **Blocked by:** C2
...
### D1 · Triage all fifteen measures
**Status:** todo · **Blocked by:** C3
...
### D2 · Widen the representation for the properties that need it
**Status:** todo · **Blocked by:** D1
...
### D3 · Report error bars, and score as a median over benign transforms
**Status:** todo · **Blocked by:** D1
